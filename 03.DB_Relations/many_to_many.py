...
class Person(SQLModel, table=True):
    ...
    name: str
    ebooks: list["Ebook"] = Relationship(back_populates="persons", link_model=PersonEbookLink)

class Ebook(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
    name: str
    persons: list["Person"] = Relationship(back_populates="ebooks", link_model=PersonEbookLink)
